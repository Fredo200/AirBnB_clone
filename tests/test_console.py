...
class TestHBNBCommand_prompting(unittest.TestCase):
    """ Unit tests for testing the prompting of the HBNB command interpreter """
...
class TestHBNBCommand_help(unittest.TestCase):
    """ Unit tests for testing the help messages of the HBNB command interpreter """

    def test_help_quit(self):
        h = "Quit command to exit or end the program"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_EOF(self):
        h = "EOF signal to exit or end the program"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_all(unittest.TestCase):
    """ Unit tests for testing all of the HBNB command interpreter """
...
class TestHBNBCommand_count(unittest.TestCase):
    """ Unit tests for testing count method of HBNB comand interpreter """
